...
<div class="cover-container d-flex w-100 p-3 mx-auto flex-column text-center">
    ...
    <main role="main" class="inner cover mt-5">
        <h1 class="cover-heading">Good Morning, Dude!</h1>
                ...
                <div class="col">
                    <form class="form-inline">
                        <div class="form-group col-10 ml-5 mb-2">
                            <input class="form-control form-control-lg col-12" type="text" placeholder="e.g https://fabelio.com/cp/ruang-kerja/meja-kerja/meja-laptop.html">
                        </div>
